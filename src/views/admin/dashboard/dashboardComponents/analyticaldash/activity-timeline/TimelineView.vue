        ...
        <div>
          ...
          <div class="mt-3 v-row">
            ...
            <div class="v-col-md-9 mt-3 mt-md-0">
              ...
              <v-btn color="primary" variant="contained" flat class="mt-3">
    ...
    <div class="sl-item my-4 border-top pt-4">
      ...
      <div class="sl-right">
        <div>
          ...
          <v-alert class="mt-4 fs-3" color="primary" variant="contained-text">
    ...
    <div class="sl-item my-4 border-top pt-4">
      ...
      <div class="sl-right">
        <div>
          ...
          <v-alert class="mt-4 fs-3" color="secondary" variant="contained-text">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
            eiusmod tempor incididunt
          </v-alert>
        </div>
